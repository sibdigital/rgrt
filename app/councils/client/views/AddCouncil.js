...
import {
	...
	Modal,
	Icon,
	Box, Label, Margins, CheckBox, Table,
...
export function AddCouncilPage() {
	...
	return <AddCouncilWithNewData council={getNewData} onChange={onChange}/>;
}
...
function AddCouncilWithNewData({ council, onChange, context }) {
	const t = useTranslation();
	...
	const hasAdded = useMemo(() => _id !== '', [_id]);
