...
Template.menuBar.events({
	'click .goToSection'(e, instance) {
		...
		//Blaze.getView($('cbp-ig-grid')[0]).templateInstance().someReactiveVar.set('changed')

		if (document.activeElement === e.currentTarget) {
			e.currentTarget.blur();
		}
		console.log(Template.gridOfIcons.__helpers.get('myInstance'))
		console.log(Blaze.getView($(Template.gridOfIcons.viewName)[0]))
		console.log(Template.gridOfIcons.viewName)
